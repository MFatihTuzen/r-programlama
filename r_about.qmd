...
## R Neden Veri Analizi İçin Güçlüdür?
...
1.  Önce R kurulur.
2.  Daha sonra RStudio kurulur.
3.  RStudio açıldığında kurulu R sürümünü otomatik olarak algılar.
...
![](images/clipboard-3682385766.png)
...
![](images/clipboard-2160242823.png)
...
-   **Script Editor:** Kodların yazıldığı ve saklandığı bölümdür.
-   **Console:** Kodların çalıştırıldığı bölümdür.
-   **Environment:** Oturumda oluşturulan nesnelerin listelendiği bölümdür.
-   **Files / Plots / Packages / Help:** Dosya yönetimi, grafik görüntüleme, paketler ve yardım sayfaları için kullanılan bölümdür.
...
-   kodları Console yerine script dosyalarında saklamak,
-   açıklama satırları kullanmak,
-   proje klasörü mantığıyla çalışmak,
-   dosya yollarını düzenli tutmak,
-   nesne adlarını anlamlı seçmek,
-   analiz adımlarını tekrar çalıştırılabilir biçimde yazmak.
